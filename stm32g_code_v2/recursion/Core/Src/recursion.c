...
int recursion_fib_ram2( int i )
{
  ...
  return recursion_fib_ram2( i - 1 ) + recursion_fib_ram2( i - 2 );
}

int recursion_return_ram2()
{
  return ( recursion_result  + ( -89 ) ) != 0;
}
...
{
  recursion_result = recursion_fib_ram2( recursion_input );
}
