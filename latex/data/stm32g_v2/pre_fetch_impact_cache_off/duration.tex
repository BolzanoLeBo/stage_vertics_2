...
\input{../../../macro.tex}
\pgfplotstableread[col sep=tab]{compare_prefetch_cache_off-duration.csv}\Data
...
\begin{tikzpicture}[xscale=1,yscale=1]
    \begin{axis}
        ...
        \addplot[mark=square*,color=green] table [col sep=comma, y expr={100*(\thisrow{recursion})}] {\TransposedData};
        %\addlegendentry[align=center]{Recursion},
