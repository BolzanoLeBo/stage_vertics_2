...
\begin{frame}{Goal of the study}
	...
	\begin{enumerate}
		\uncover<1->{\item Get energy consumption data with different memory configurations on cortex M4 microcontrolers.}
		\uncover<2->{\item Measure the impact of each memory allocation.}
		\uncover<3->{\item Create a model to optimize the energy consumption.}
		\uncover<4->{\item Find scheduling algorithms which can work for this case.}
	\end{enumerate}
\end{frame}
