...
void matrix1_pin_down_ram( int A[  ], int B[  ], int C[  ] )
{
  int i;
  volatile int x = 1;
...
void matrix1_init_ram( void )
{
  matrix1_pin_down_ram( &matrix1_A[ 0 ], &matrix1_B[ 0 ], &matrix1_C[ 0 ] );
}
...
void matrix1_pin_down_ram2( int A[  ], int B[  ], int C[  ] )
{
  int i;
  volatile int x = 1;
...
void matrix1_init_ram2( void )
{
  matrix1_pin_down_ram2( &matrix1_A[ 0 ], &matrix1_B[ 0 ], &matrix1_C[ 0 ] );
}
